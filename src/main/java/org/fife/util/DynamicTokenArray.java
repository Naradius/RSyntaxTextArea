 ...
 * @version 0.8
 */
public class DynamicTokenArray implements Serializable {
	 ...
	 *         negative.
	 */
	public DynamicTokenArray(int initialCapacity) {
	 ...
	 *         <code>null</code>.
	 */
	public DynamicTokenArray(int[] intArray) {
	 ...
	 *         <code>null</code>.
	 */
	public void add(int index, Token[] intArray) {
		if (index>size) {
	 ...
	 */
	public boolean contains(Token integer) {
	 ...
	 * @return The <code>int</code> at the specified position in this array.
	 */
	public Token getUnsafe(int index) {
	 ...
	 * @param value The value to set it to.
	 */
	public void setUnsafe(int index, Token value) {
		// Small enough to be inlined.
		data[index] = value;
	}
